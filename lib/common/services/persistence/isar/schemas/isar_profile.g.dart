...
const IsarProfileSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'selectedImageIndex': PropertySchema(
      id: 2,
      name: r'selectedImageIndex',
      type: IsarType.long,
    )
  },
...
void _isarProfileSerialize(
  ...
  writer.writeLong(offsets[2], object.selectedImageIndex);
}
...
IsarProfile _isarProfileDeserialize(
  ...
  object.selectedImageIndex = reader.readLong(offsets[2]);
  return object;
}
...
extension IsarProfileQueryWhereSort
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterWhere> anyName() {
    return QueryBuilder.apply(this, (query) {
...
extension IsarProfileQueryWhere
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterWhereClause> nameEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterWhereClause> nameNotEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterWhereClause> nameGreaterThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterWhereClause> nameLessThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterWhereClause> nameBetween(
    String lowerName,
    String upperName, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterWhereClause> nameStartsWith(
      String NamePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'name',
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterWhereClause> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'name',
        value: [''],
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterWhereClause> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension IsarProfileQueryFilter
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterFilterCondition>
      selectedImageIndexEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'selectedImageIndex',
        value: value,
      ));
    });
  }
...
extension IsarProfileQuerySortBy
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterSortBy> sortByIsDefault() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDefault', Sort.asc);
    });
  }

  QueryBuilder<IsarProfile, IsarProfile, QAfterSortBy> sortByIsDefaultDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterSortBy>
      sortBySelectedImageIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'selectedImageIndex', Sort.asc);
    });
  }

  QueryBuilder<IsarProfile, IsarProfile, QAfterSortBy>
      sortBySelectedImageIndexDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'selectedImageIndex', Sort.desc);
    });
  }
}
...
extension IsarProfileQuerySortThenBy
  ...
  QueryBuilder<IsarProfile, IsarProfile, QAfterSortBy> thenByIsDefault() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDefault', Sort.asc);
    });
  }

  QueryBuilder<IsarProfile, IsarProfile, QAfterSortBy> thenByIsDefaultDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDefault', Sort.desc);
    });
  }
...
extension IsarProfileQueryWhereDistinct
  ...
  QueryBuilder<IsarProfile, IsarProfile, QDistinct> distinctByIsDefault() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProfile, IsarProfile, QDistinct>
      distinctBySelectedImageIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'selectedImageIndex');
    });
  }
}
...
extension IsarProfileQueryProperty
  ...
  QueryBuilder<IsarProfile, bool, QQueryOperations> isDefaultProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProfile, int, QQueryOperations>
      selectedImageIndexProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'selectedImageIndex');
    });
  }
}
